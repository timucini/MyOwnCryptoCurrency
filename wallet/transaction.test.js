...
describe('Transaction', () => {
    ...
    describe('outputMap', () => {
        ...
        it('outputs the amount the amount to the recipient', () => {
    ...
    describe('validTransaction()', () => {
        ...
        describe('then the transaction is invalid', () => {
    ...
    describe('update()', () => {
        ...
        describe('and the amount is valid', () => {
            ...
            it('outputs the amount the amount to the next recipient', () => {
            ...
            describe('and another update for the same recipient', () => {
                ...
                it('adds to the ricipient amount', () => {
